...
<a style="text-decoration:none" href="http://djqkp.osxo.cn/30"><div>
    <button class="btn"><i class="animation"></i>安装导向(update)<i class="animation"></i>
    </button>
</div></a><br>
<a style="text-decoration:none" href="https://www.migufun.com/miguplay/middleGame/gameplay/400007864?gameName=%E5%8E%9F%E7%A5%9E"><div>
    <button class="btn"><i class="animation"></i>玩会原神ʘᴗʘ<i class="animation"></i>
    </button>
</div></a>
